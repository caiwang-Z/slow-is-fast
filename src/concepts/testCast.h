...
namespace TestCastBasic {
	...
	// dynamic cast: used for safe downcasting at runtime. atempt the conversion and do something if it fails
}
...
namespace TestDynamicCast {
	...
	public:
		...
		/*
		 ...
		 dealing with inheritance hierarchies where you need safe type conversions at runtime.
		*/
	};
